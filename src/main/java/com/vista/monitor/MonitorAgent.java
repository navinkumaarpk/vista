        ...
        for (String sg : groups) {
            try {
                ...
                log.info("Monitor finding: {} -> {} (approval={})",
                        sg, finding.classification(), finding.requiresApproval());
            } catch (Exception e) {
